...
# for source files.
exclude_trees = ['.build', 'jsbnest', 'docs', '.hg', 'files']
...
#html_additional_pages = {'docs/baseplugs/': '*', 'docs/gozerplugs/': '*'}
...
latex_documents = [
  ('index', 'JSONBOT.tex', ur'JSONBOT Documentation',
   ur'Bart Thate', 'manual'),
]
